...
class RetencionesSeeder extends Seeder
{
    ...
    {
        $retenciones = Collect([
            ["limite_inferior" => 0.01,"limite_superior" =>	148.40,"cuota" =>0.00,"porcentaje_excedente"=>	1.92,"periodo" => "SEMANAL"],
            ...
            ["limite_inferior" => 2213.90,"limite_superior" =>	2573.55,"cuota" =>	177.80,"porcentaje_excedente"=>	16.00,"periodo" => "SEMANAL"],
            ...
            ["limite_inferior" => 4744.06,"limite_superior" =>	5514.75,"cuota" =>	381.00,"porcentaje_excedente"=> 16.00,"periodo" => "QUINCENAL"],
            ["limite_inferior" => 5514.76,"limite_superior" =>	6602.70,"cuota" =>	504.30,"porcentaje_excedente"=>	17.92,"periodo" => "QUINCENAL"],
            ["limite_inferior" => 6602.71,"limite_superior" =>	13316.70,"cuota" =>	699.30,"porcentaje_excedente" =>21.36, "periodo" => "QUINCENAL"],
