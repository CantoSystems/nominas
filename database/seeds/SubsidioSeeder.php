...
class SubsidioSeeder extends Seeder
{
    ...
    public function run()
    {
        $subsidios = Collect([
            ...
            ["para" => 1699.89, "hasta" => 0,"cantidad" =>0	,"periodo" => "SEMANAL"],
            ["para" => 0.01, "hasta" => 872.85, "cantidad" =>200.85,"periodo" => "QUINCENAL"],
            ["para" => 872.86,"hasta" => 1309.20, "cantidad" =>	200.7,"periodo" => "QUINCENAL"],
            ["para" => 1309.21,	"hasta" =>  1713.60 , "cantidad" =>200.7,"periodo" => "QUINCENAL"],
            ["para" =>1713.61,"hasta" => 1745.70 ,"cantidad" =>	193.8,"periodo" => "QUINCENAL"],
            ["para" =>1745.71,"hasta" => 2193.75, "cantidad" =>	188.7,"periodo" => "QUINCENAL"],
            ...
            ["para" =>3071.41,"hasta" =>  3510.15, "cantidad" =>125.1,"periodo" => "QUINCENAL"],
            ["para" =>3510.16,"hasta" =>3642.60,"cantidad" =>107.4,"periodo" => "QUINCENAL"],
            ["para" =>3642.61,	"hasta" =>0,"cantidad" =>0,"periodo" => "QUINCENAL"],
