                                ...
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-dos-perfil-tab" data-toggle="pill"
                                            href="#custom-tabs-dos-perfil" role="tab"
                                            aria-controls="custom-tabs-dos-perfil" aria-selected="false">Personal 2</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-cinco-referencias-tab" data-toggle="pill"
                                            ...
                                            aria-controls="custom-tabs-cinco-referencias" aria-selected="false">Referencias
                                            Nuevas</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tab-content" id="custom-tabs-one-tabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="custom-tabs-one-personal" role="tabpanel"
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-1 mb-2">
                                                    <label class="titulo">Clave <strong
                                                ...
                                                <div class="col-md-3">
                                                    <label class="titulo">Clasificación <strong
                                                            class="obligatorio">*</strong></label>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">Departamento <strong
                                                            class="obligatorio">*</strong></label>
                                                    @if (isset($persona))
                                                    ...
                                                    @else
                                                        <select class="custom-select" name="clave_departamento">
                                                            <option selected disabled value="">Seleccione una opción:
                                                                <strong class="obligatorio">*</strong></option>
                                                            @foreach ($departamentos as $depa)
                                                                <option value="{{ $depa->clave_departamento }}">
                                                                    {{ $depa->departamento }}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    @if (isset($persona))
                                                        <select class="custom-select" name="clave_puesto">
                                                            ...
                                                            @foreach ($puestos as $puest)
                                                                ...
                                                                @else
                                                                    <option value="{{ $puest->clave_puesto }}">
                                                                        {{ $puest->nombre_puesto }}
                                                                    </option>
                                                                @endif
                                                            @endforeach
                                                    ...
                                                    @else
                                                        <select class="custom-select" name="clave_puesto">
                                                            <option selected disabled value="">Seleccione una
                                                                opción:<strong class="obligatorio">*</strong></option>
                                                            @foreach ($puestos as $puest)
                                                                <option value="{{ $puest->clave_puesto }}">
                                                                    {{ $puest->nombre_puesto }}
                                                                </option>
                                                ...
                                                <div class="col-md-2">
                                                    <label class="titulo">RFC <strong
                                                            class="obligatorio">*</strong></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->rfc ?? '' }}" maxlength="13" name="rfc"
                                                        onkeyup="mayus(this);"
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->curp ?? '' }}" minlength="18" maxlength="18"
                                                        name="curp" onkeyup="mayus(this);">
                                                    @error('curp')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->imss ?? '' }}" maxlength="11" name="imss"
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">INE <strong
                                                            class="obligatorio">*</strong></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->ine ?? '' }}" maxlength="18" name="ine"
                                                        onkeyup="mayus(this);">
                                                    @error('ine')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->pasaporte ?? '' }}" maxlength="6"
                                                        name="pasaporte" onkeyup="mayus(this);">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">Cartilla</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->cartilla ?? '' }}" maxlength="10"
                                                        name="cartilla" onkeyup="mayus(this);">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">Licencia</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->licencia ?? '' }}" maxlength="5"
                                                        name="licencia" onkeyup="mayus(this);">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">Documento migratorio</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->documento_migratorio ?? '' }}"
                                                        name="documento_migratorio" maxlength="13"
                                                        onkeyup="mayus(this);">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">Número externo <strong
                                                            class="obligatorio">*</strong></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->numero_externo ?? '' }}"
                                                        name="numero_externo" maxlength="4"
                                                        onkeypress="return numeros(event)">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->numero_interno ?? '' }}"
                                                        name="numero_interno" maxlength="4"
                                                        onkeypress="return numeros(event)">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">CP <strong class="obligatorio">*</strong>
                                                    </label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $persona->cp ?? '' }}" name="cp" maxlength="6"
                                                        onkeypress="return numeros(event)">
                                                    @error('cp')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label class="titulo">Tipo de sangre <strong
                                                            class="obligatorio">*</strong> </label>
                                                    <input type="text" class="form-control"
                                                ...
                                                <div class="col-md-1 mb-3">
                                                    <label class="titulo">Estatura <strong
                                                            class="obligatorio">*</strong></label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $persona->estatura ?? '' }}" name="estatura"
                                                        min="1.20" max="2.5" step="0.01">
                                                    @error('estatura')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-1 mb-3">
                                                    <label class="titulo">Peso <strong class="obligatorio">*</strong>
                                                    </label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $persona->peso ?? '' }}" name="peso" min="30"
                                                        max="200" step="0.01">
                                                    @error('peso')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-dos-perfil" role="tabpanel"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <label class="titulo">Lugar de Origen <strong
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="titulo">Nombre del Padre <strong
                                                            style="color:red">*</strong> </label>
                                                ...
                                                <div class="col-md-1 mb-3">
                                                    ...
                                                    @else
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="finado_padre" value="option1" aria-label="">
                                                            <label class="titulo">Finado</label>
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="direccion_padre"
                                                        value="{{ $persona->direccion_padre ?? '' }}"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="titulo">Ocupación</label>
                                                    <input type="text" class="form-control" name="ocupacion_padre"
                                                        value="{{ $persona->ocupacion_padre ?? '' }}"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label class="titulo">Nombre de la Madre <strong
                                                            style="color:red">*</strong></label>
                                                    <input type="text" class="form-control"
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="direccion_madre"
                                                        value="{{ $persona->direccion_madre ?? '' }}"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="titulo">Ocupación</label>
                                                    <input type="text" class="form-control" name="ocupacion_madre"
                                                        value="{{ $persona->ocupacion_madre ?? '' }}"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                </div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <label class="titulo">Funciones de Oficina <strong
                                                            style="color:red">*</strong></label>
                                                    <input type="text" class="form-control" name="funciones_oficina"
                                                        value="{{ $persona->funciones_oficina ?? '' }}"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="titulo">Máquinas de Oficina o Taller que Maneje <strong
                                                            style="color:red">*</strong></label>
                                                    <input type="text" class="form-control" maxlength="20"
                                                        name="maquinas_oficina"
                                                        value="{{ $persona->maquinas_oficina ?? '' }}"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label class="titulo">Software que conoce <strong
                                                            style="color:red">*</strong> </label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <label class="titulo">% de Participación <strong
                                                            style="color:red">*</strong></label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $persona->porcentaje ?? '' }}" name="porcentaje"
                                                        min="0.1" max="100" step="0.01" id="porcentaje">
                                                    @error('porcentaje')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <!--Fin titulos-->
                                                <!--Inicio Primaria-->
                                                <label for="" class="col-form-label col-sm-2 titulo">Primaria
                                                    <strong style="color:red">*</strong></label>
                                                <div class="col-sm-3">
                                                    <input type="text" value="{{ $persona->primaria ?? '' }}"
                                                        name="primaria" class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                    @error('primaria')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" value="{{ $persona->titulo_primaria ?? '' }}"
                                                        name="titulo_primaria" class="form-control"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                ...
                                                <!--Inicio Secundaria-->
                                                <label for=""
                                                    class="col-form-label col-sm-2 titulo">Secundaria</label>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-4">
                                                    <input name="duracion_secundaria"
                                                        value="{{ $persona->duracion_secundaria ?? '' }}"
                                                        class="form-control" id="duracion6">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text"
                                                        value="{{ $persona->titulo_secundaria ?? '' }}"
                                                ...
                                                <!--Inicio Preparatoria-->
                                                <label for=""
                                                    class="col-form-label col-sm-2 titulo">Preparatoria</label>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="titulo_preparatoria"
                                                        value="{{ $persona->titulo_preparatoria ?? '' }}"
                                                ...
                                                <!--Inicio Profesional-->
                                                <label for=""
                                                    class="col-form-label col-sm-2 titulo">Profesional</label>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="titulo_profesional"
                                                        value="{{ $persona->titulo_profesional ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                <!--FIN Profesional-->
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="otras"
                                                        value="{{ $persona->otras ?? '' }}" class="form-control"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-sm-4">
                                                    <input name="duracion_otras"
                                                        value="{{ $persona->duracion_otras ?? '' }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="duracion_trabajo"
                                                        value="{{ $persona->duracion_trabajo ?? '' }}"
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="duracion_trabajo1"
                                                        value="{{ $persona->duracion_trabajo1 ?? '' }}"
                                                        class="form-control" id="duracion2">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input name="duracion_trabajo2"
                                                        value="{{ $persona->duracion_trabajo2 ?? '' }}"
                                                        class="form-control" id="duracion3">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input name="duracion_trabajo3"
                                                        value="{{ $persona->duracion_trabajo3 ?? '' }}"
                                                        class="form-control" id="duracion4">
                                                </div>
                                                <label for="" class="col-form-label col-sm-12 titulo">Nombre de la
                                                    Compañia</label>
                                                <div class="col-sm-3">
                                                    <input type="text" name="nombre_compania"
                                                        value="{{ $persona->nombre_compania ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="nombre_compania1"
                                                        value="{{ $persona->nombre_compania1 ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" name="nombre_compania2"
                                                        value="{{ $persona->nombre_compania2 ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" name="nombre_compania3"
                                                        value="{{ $persona->nombre_compania3 ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                ...
                                                <label for=""
                                                    class="col-form-label col-sm-12 titulo">Dirección</label>
                                                <div class="col-sm-3">
                                                    <input type="text" name="direccion_compania"
                                                        value="{{ $persona->direccion_compania ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="direccion1_trabajo1"
                                                        value="{{ $persona->direccion1_trabajo1 ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" name="direccion_compania2"
                                                        value="{{ $persona->direccion_compania2 ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                ...
                                                <label for=""
                                                    class="col-form-label col-sm-1 titulo">Télefono</label>
                                                <div class="col-sm-3">
                                                ...
                                                <label for=""
                                                    class="col-form-label col-sm-12 titulo">Sueldo</label>
                                                <div class="col-sm-3">
                                                    <input type="number" value="{{ $persona->sueldo ?? '' }}"
                                                        step="0.01" min="0.00" max="100000.0" name="sueldo"
                                                        class="form-control" onkeypress="return numeros(event)">
                                                    @error('sueldo')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number" value="{{ $persona->sueldo1 ?? '' }}"
                                                        step="0.01" min="0.00" max="100000.0" name="sueldo1"
                                                        class="form-control" onkeypress="return numeros(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="number" value="{{ $persona->sueldo2 ?? '' }}"
                                                        step="0.01" min="0.00" max="100000.0" name="sueldo2"
                                                        class="form-control" onkeypress="return numeros(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="number" value="{{ $persona->sueldo3 ?? '' }}"
                                                        step="0.01" min="0.00" max="100000.0" name="sueldo3"
                                                        class="form-control" onkeypress="return numeros(event)">
                                                </div>
                                                <!--FIN sueldo Referencias-->
                                                <!--INCIO Motivo separación Referencias-->
                                                <label for="" class="col-form-label col-sm-12 titulo">Motivo de
                                                    la
                                                    Separación</label>
                                                <div class="col-sm-3">
                                                    <input type="text"
                                                        value="{{ $persona->motivo_separacion ?? '' }}"
                                                        name="motivo_separacion" class="form-control"
                                                        onkeyup="mayus(this);" onkeypress="return validar(event)">
                                                    ...
                                                    @if (isset($persona))
                                                        @if ($persona->solicitar_informes == 0)
                                                            <input checked type="checkbox" name="solicitar_informes"
                                                                class="form-control">
                                                        @else
                                                            <input type="checkbox" name="solicitar_informes"
                                                                class="form-control">
                                                        @endif
                                                    ...
                                                    @if (isset($persona))
                                                        @if ($persona->solicitar_informes1 == 0)
                                                            <input checked type="checkbox" name="solicitar_informes1"
                                                                class="form-control">
                                                        @else
                                                            <input type="checkbox" name="solicitar_informes1"
                                                                class="form-control">
                                                        @endif
                                                    @else
                                                        <input type="checkbox" name="solicitar_informes1"
                                                    ...
                                                    @if (isset($persona))
                                                        @if ($persona->solicitar_informes2 == 0)
                                                            <input checked type="checkbox" name="solicitar_informes2"
                                                                class="form-control">
                                                        @else
                                                            <input type="checkbox" name="solicitar_informes2"
                                                                class="form-control">
                                                        @endif
                                                    @else
                                                        <input type="checkbox" name="solicitar_informes2"
                                                    ...
                                                    @if (isset($persona))
                                                        @if ($persona->solicitar_informes3 == 0)
                                                            <input checked type="checkbox" name="solicitar_informes3"
                                                                class="form-control">
                                                        @else
                                                            <input type="checkbox" name="solicitar_informes3"
                                                                class="form-control">
                                                        @endif
                                                    @else
                                                        <input type="checkbox" name="solicitar_informes3"
                                                ...
                                                <label for=""
                                                    class="col-form-label col-sm-12 titulo">Razones</label>
                                                <div class="col-sm-3">
                                                    <input type="text" value="{{ $persona->razones ?? '' }}"
                                                        name="razones" class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                    @error('razones')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" value="{{ $persona->razones1 ?? '' }}"
                                                        name="razones1" class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" value="{{ $persona->razones2 ?? '' }}"
                                                        name="razones2" class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                <div class="col-sm-3">
                                                    <input type="text" value="{{ $persona->razones3 ?? '' }}"
                                                        name="razones3" class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                </div>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" name="direccion_trabajo"
                                                        value="{{ $persona->direccion_trabajo ?? '' }}"
                                                        class="form-control" onkeyup="mayus(this);"
                                                        onkeypress="return validar(event)">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text"
                                                        value="{{ $persona->telefono_referencia ?? '' }}"
                                                        name="telefono_referencia"
                                                        class="form-control telefono_referencia">
                                                    ...
                                                    @enderror
                                                    <input type="text"
                                                        value="{{ $persona->telefono_referencia1 ?? '' }}"
                                                        name="telefono_referencia1"
                                                        class="form-control telefono_referencia1">
                                                    <input type="text"
                                                        value="{{ $persona->telefono_referencia2 ?? '' }}"
                                                ...
                                                <div class="col-sm-2">
                                                    <label class="titulo" style="text-align: left;">Tiempo
                                                        (Años)</label>
                                                    <input type="number" value="{{ $persona->tiempo ?? '' }}"
                                                        name="tiempo" min="1" max="99" step="1"
                                                    ...
                                                    @enderror
                                                    <input type="number" value="{{ $persona->tiempo1 ?? '' }}"
                                                        name="tiempo1" min="1" max="99" step="1"
                                                        class="form-control" maxlength="2"
                                                        onkeypress="return numeros(event)">
                                                    <input type="number" value="{{ $persona->tiempo2 ?? '' }}"
                                                        name="tiempo2" min="1" max="99" step="1"
                                                        class="form-control" maxlength="2"
                                                        onkeypress="return numeros(event)">
                                                </div>
                                            </div>
                                        ...
                                        <!--Inicio Contratación-->
                                        <div class="tab-pane fade" id="custom-tabs-cuatro-contratacion"
                                            role="tabpanel" aria-labelledby="custom-tabs-cuatro-contratacion-tab">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    @else
                                                        <select class="custom-select" name="turno">
                                                            <option selected disabled value="">Seleccione una
                                                                opción: <strong style="color:red">*</strong></option>
                                                            <option value="DIURNO">Diurno</option>
                                                            <option value="NOCTURNO">Nocturno</option>
                                                            <option value="MIXTO">Mixto</option>
                                                        </select>
                                                    ...
                                                    @if (isset($persona))
                                                        <select class="custom-select" name="contrato">
                                                            @if ($persona->contrato == '')
                                                                ...
                                                                <option value="INDETERMINADO">Tiempo indeterminado
                                                                </option>
                                                            ...
                                                            @elseif($persona->contrato == 'DETERMINADO')
                                                                ...
                                                                <option value="PRUEBA">Prueba</option>
                                                                <option selected value="DETERMINDO">Tiempo determinado
                                                                </option>
                                                                <option value="INDETERMINADO">Tiempo indeterminado
                                                                </option>
                                                            @elseif($persona->contrato == 'INDETERMINADO')
                                                                ...
                                                                <option value="PRUEBA">Prueba</option>
                                                                <option value="DETERMINDO">Tiempo determinado</option>
                                                                <option selected value="INDETERMINADO">Tiempo
                                                ...
                                                <div class="col-md-2 mb-2">
                                                    ...
                                                    <input type="number" class="form-control" name="sueldo_diario"
                                                        value="{{ $persona->sueldo_diario ?? '' }}" maxlength="5"
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <br>
                                                    <label class="titulo">Tipo salario <strong
                                                ...
                                                <div class="col-md-1 mb-3">
                                                    ...
                                                    <input type="number" value="{{ $persona->dias ?? '' }}"
                                                        class="form-control" name="dias" min="1"
                                                        max="30" step="1">
                                                    @error('dias')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                ...
                                                <div class="col-md-1 mb-3">
                                                    <br>
                                                    <label class="titulo">Horas<strong
                                                            style="color:red">*</strong></label>
                                                    <input type="number" value="{{ $persona->horas_diarias ?? '' }}"
                                                        class="form-control" name="horas_diarias" min="1"
                                                        max="24" step="any" value="">
                                                    @error('horas_diarias')
                                                        <div class="alert alert-secondary">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <br>
                                                    <label class="titulo">Banco <strong
                                                            style="color:red">*</strong></label>
                                                    @if (isset($persona))
                                                        <select class="custom-select" name="clave_banco">
                                                            ...
                                                            @foreach ($bancos as $banco)
                                                                ...
                                                                @else
                                                                    <option value="{{ $banco->clave_banco }}">
                                                                        {{ $banco->nombre_banco }}
                                                                    </option>
                                                                @endif
                                                            @endforeach
                                                ...
                                                <div class="col-md-4 mb-4">
                                                    <br>
                                                    <label class="titulo">Cuenta Bancaria <strong
                                                            style="color:red">*</strong></label>
                                                    <input type="text"
                                                        value="{{ $persona->cuenta_bancaria ?? '' }}"
                                                        class="form-control" maxlength="20" name="cuenta_bancaria"
                                                ...
                                                <div class="col-md-4 mb-4">
                                                    <br>
                                                    <label class="titulo">Clabe Interbancaria <strong
                                                            style="color:red">*</strong></label>
                                                    <input type="text"
                                                        value="{{ $persona->clabe_interbancaria ?? '' }}"
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    @if (isset($persona))
                                                        <div class="form-check">
                                                            @if ($persona->ptu == 0)
                                                                <input checked class="form-check-input" type="checkbox"
                                                                    name="ptu" value="option1" aria-label="">
                                                            @else
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="ptu" value="option1" aria-label="">
                                                            @endif
                                            ...
                                            <div class="margin">
                                                <div class="btn-group">
                                                                ...
                                                                <div class="btn-group">
                                                                    @if (isset($persona))
                                                                        <div class="form-group">
                                                                            <button type="submit" name="acciones"
                                                                                value="primero" id="primero"
                                                                                class="botonesgrandes"><i
                                                                                    class="fas fa-backward"></i></button>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <button type="submit" name="acciones"
                                                                                value="atras" id="atras"
                                                                                class="botonesgrandes"><i
                                                                                    class="fas fa-arrow-circle-left"></i></button>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <button type="submit" name="acciones"
                                                                                value="siguiente" id="siguiente"
                                                                                class="botonesgrandes"><i
                                                                                    class="fas fa-arrow-circle-right"></i></button>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <button type="submit" name="acciones"
                                                                                value="ultimo" id="ultimo"
                                                                                class="botonesgrandes"><i
                                                    ...
                                                    @canany(['administrador', 'capturista'])
                                                        <div class="form-group">
                                                            <button type="button" id="nuevo" class="botonesgrandes">
                                                    ...
                                                    <div class="form-group">
                                                        <button id="nuevo_reg" name="acciones" value="registrar"
                                                            ...
                                                            class="botonesgrandes"><i class="fas fa-save"></i></button>
                                                    </div>
                                                    <div class="form-group">
