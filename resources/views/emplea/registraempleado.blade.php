  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="card-body">
                  ...
                  <div class="tab-content" id="custom-tabs-one-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                      <form method="GET" action="{{route('emplea.index')}}"><!--Inicio FORM-->
                        <!--Personal 1-->
                        <div class="form-row">
                          <div class="col-md-1 mb-2">
                            <label for="validationDefault01">Clave</label>
                            <input type="text" class="form-control"  onkeyup="mayus(this);" name="clave_empleado"  maxlength="4">
                          ...
                          <div class="col-md-2">
                            ...
                            <input  type="text" class="form-control" name="clasificacion"  onkeyup="mayus(this);" onkeypress="return validar(event)">
                            @error('clasificacion')
                                <div class="alert alert-secondary">
                                    {{ $message }}
                                </div>
                          ...
                          <div class="col-md-2">
                            ...
                            <input  type="text" class="form-control" maxlength="13" name="rfc" onkeyup="mayus(this);"  pattern="^([A-ZÑ\x26]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1])([A-Z]|[0-9]){2}([A-ZÑ\x26]|[0-9]){1})?$">
                            @error('rfc')
                                <div class="alert alert-secondary">
                                    {{ $message }}
                                </div>
                          ...
                          <div class="col-md-1 mb-3">
                            ...
                            <input  type="number" class="form-control" name="estatura" min="1.20" max="2.5" step="0.01">
                            @error('estatura')
                                <div class="alert alert-secondary">
                                    {{ $message }}
                                </div>
                          ...
                          <div class="col-md-1 mb-3">
                            ...
                            <input  type="number" class="form-control" name="peso" min="30" max="200" step="0.01">
                            @error('peso')
                                <div class="alert alert-secondary">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                      <div class="form-row">
                        <div class="col-md-3 mb-2">
                          ...
                          <input  type="text" class="form-control" name="enfermedad_cronica"onkeyup="mayus(this);" onkeypress="return validar(event)">
                        </div>
                        <div class="col-md-3">
                          <label for="validationDefault02">Práctica de Deportes</label>
                          <input  type="text" class="form-control" name="deporte" onkeyup="mayus(this);" onkeypress="return validar(event)">
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <input  type="text" class="form-control" name="software" monkeyup="mayus(this);" onkeypress="return validar(event)">
                          @error('software')
                                <div class="alert alert-secondary">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-one-messages" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                      <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                          ...
                          <input  type="number" class="form-control" name="porcentaje" min="0.1" max="100" step="0.01" id="porcentaje">
                          @error('porcentaje')
                                <div class="alert alert-secondary">
                                    {{ $message }}
                                </div>
       ...
       <button id="nuevo_reg" name="acciones" value="registrar" type="submit" class="botonesgrandes"><i class="fas fa-save"></i></button>
       <button name="acciones" value="cancelar" id="cancelar_reg" type="submit" class="botonesgrandes"><i class="far fa-window-close"></i></button>
      </div>
