                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item {{ !Route::is('control.index') ?: 'active' }}">
                                    <a name="botonNominas" id="botonNominas" href="{{ route('control.index') }}"
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item {{ !Route::is('aguinaldosP.index') ?: 'active' }}">
                                    <a name="botonAguinaldo" id="botonAguinaldo"
                                        href="{{ route('aguinaldosP.index') }}" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Prenómina</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item {{ !Route::is('ptu.index') ?: 'active' }}">
                                    <a name="botonAguinaldo" id="botonAguinaldo" href="{{ route('ptu.index') }}"
                                        class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Prenómina</p>
                                    </a>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        let htmlTags = '<tr>' +
                            ...
                            '<input class="totales3" id="trabajadorIsr" type="hidden" value=" ' + data[
                                2].toFixed(2) + ' ">' +
                            '</td>' +
                            '</tr>'
                    ...
                    success: function(data) {
                        ...
                        if (data[2] != null) {
                            let htmlTags = '<tr>' +
                                ...
                                '<input type="hidden" class="monto" value="' + data[2].toFixed(2) +
                                '">' +
                                '<input class="totales3" id="trabajadorImss" type="hidden" value="' +
                                data[
                                    2].toFixed(2) + '">' +
                                '</td>' +
                                '</tr>'
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data[0] != '') {
                                    let htmlTags = '<tr>' +
                                        '<td style="text-align: center;">' + data[0] +
                                        '<input type="hidden" class="form-control clvCncpt" value="' +
                                        data[0] + '">' +
                                        '</td>' +
                                        '<td colspan="2" style="text-align:center;">' +
                                        data[1] +
                                        '<input type="hidden" class="form-control clvEmp" value="' +
                                        data[4] + '">' +
                                        '</td>' +
                                        '<td style="text-align: center;">$' + data[3]
                                        .toFixed(2) +
                                        '<input type="hidden" class="form-control monto totales2" value="' +
                                        data[3].toFixed(2) + '">' +
                                        '</td>' +
                                        '</tr>'
                                    ...
                                    $(".totales2").each(function(index, value) {
                                        if ($.isNumeric($(this).val())) {
                                            importe_total2 = importe_total2 + eval(
                                                $(this).val());
                                        }
                                    });
                                    $(".totalDeducciones").val(importe_total2.toFixed(2));
                                ...
                                let htmlTags = '<tr>' +
                                    ...
                                    '<input type="hidden" class="clvEmp" value="' + data[
                                        5] + '">' +
                                    '</td>' +
                                    ...
                                    success: function(data) {
                                        $.each(data, function(index) {
                                            htmlTags = '<tr>' +
                                                ...
                                                data[index]
                                                .clave_concepto +
                                                '<input type="hidden" class="clvCncpt" value="' +
                                                data[index]
                                                .clave_concepto + '">' +
                                                '</td>' +
                                                '<td style="text-align: center;">' +
                                                data[index].concepto +
                                                '<input type="hidden" class="clvEmp" value="' +
                                                data[index]
                                                .clave_empleado + '">' +
                                                '</td>' +
                                                ...
                                                '<td  style="text-align: center;">$ ' +
                                                data[index].monto +
                                                '<input type="hidden" class="monto" value="' +
                                                data[index].monto +
                                                '">' +
                                                '<input class="totales4" id="impPatron" type="hidden" value=" ' +
                                                data[index].monto +
                                                ' "></td>' +
                                                '</tr>'
                                            $('#filasPatron tbody')
                                        ...
                                        $(".totalImpuestosPatron").val(
                                            importe_total4.toFixed(2));
