                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 42%;">
                                            ...
                                            <input type="hidden" step=".01" disabled class="form-control totalPercepcionesGravadas">
                                            <input type="hidden" step=".01" disabled class="form-control totalPercepcionesExcentas">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
