...
<div class="modal fade bs-example-modal-sm" tabindex="-1" id="modal-deletebanco-{{$uma->id}}" role="dialog"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('umas.destroy', $uma->id)}}" method="POST">
                    ...
                    @csrf
                    <div class="row">
                        <h5 style="text-align: center;" class="modalPersonalizado">¿Estas seguro de eliminar este % UMA:
