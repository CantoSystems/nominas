<div class="modal fade bs-example-modal-sm" tabindex="-1" id="modal-deletearea-{{$aux->id}}" role="dialog" aria-hidden="true">
...
<form action="{{ route('areas.eliminaarea', $aux->id )}}" method="post" >
@method('DELETE')
@csrf
<div class="row">
