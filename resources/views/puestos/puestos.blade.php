                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('puestos.index')}}" method="GET" autocomplete="off">
                        <div class="row">
                            @if(!empty($aux))
                                <div class="col-md-6">
                                    <label class="titulo">Clave del puesto</label>
                                ...
                                <div class="col-md-6">
                                    <label class="titulo">Puesto</label>
                                    <strong class="obligatorio">*</strong>
                            ...
                            <div class="col-md-5">
                                    <div class="margin">
                                        <div class="btn-group">
                                            ...
                                            @if(isset($aux))
                                                <div class="form-group">
                                                    <button id="buscar" title="Buscar" type="button" data-toggle="modal" data-target="#exampleModal" sclass="botones">
                                            ...
                                            @can('administrador')
                                                @if(isset($aux))
                                                <div class="form-group">
                                                    <a href="#" title="Eliminar" id="eliminar" data-target="#modal-deletepuesto-{{$aux->id}}" data-toggle="modal">
                                                        <button type="button" class="botones">
