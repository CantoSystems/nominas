<div class="modal fade bs-example-modal-sm" tabindex="-1" id="modal-delete-{{$descanso->id}}" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('descansos.destroy', $descanso->id )}}" method="post">
                    ...
                    @csrf
                    <div class="row">
                        <h5 style="text-align: center;" class="modalPersonalizado">¿Estas seguro de eliminar día de descanso: 
                            <strong>{{$descanso->fecha_descanso}}</strong>?
                        </h5>
                    </div>
