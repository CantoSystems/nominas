      ...
      <div class="card card-secondary card-tabs">
        ...
        <div class="card-header p-0 pt-1">
          <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="custom-tabs-one-personal2-tab" data-toggle="pill" href="#custom-tabs-one-personal2" role="tab" aria-controls="custom-tabs-one-personal2" aria-selected="false">Personal 2</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="custom-tabs-one-personal3-tab" data-toggle="pill" href="#custom-tabs-one-personal3" role="tab" aria-controls="custom-tabs-one-personal3" aria-selected="false">Personal 3</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="custom-tabs-one-referencias-tab" data-toggle="pill" href="#custom-tabs-one-referencias" role="tab" aria-controls="custom-tabs-one-referencias" aria-selected="false">Referencias</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="custom-tabs-one-contratacion-tab" data-toggle="pill" href="#custom-tabs-one-contratacion" role="tab" aria-controls="custom-tabs-one-contratacion" aria-selected="false">Contratación</a>
            </li>
          </ul>
        </div><!--Final Cabeceras-->
        <!--Inicio contenido-->
        <div class="card-body">
          ...
          <div class="tab-content" id="custom-tabs-one-tabContent">
            ...
            <form method="POST" action="{{route('empleados.registrar')}}" accept-charset="UTF-8" enctype="multipart/form-data"><!--Inicio FORM-->
              {{ csrf_field() }}
                <div class="form-row">
                  <div class="col-md-1 mb-2">
                    <label for="validationDefault01">Clave:</label>
                    <input required  type="text" class="form-control" name="clave_empleado" value="" onkeypress="return numeros(event)" readonly>
                  </div>
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input required type="file" class="form-control" name="fotografia">
                  </div>
                </div><!--Fin  Row Personal-->
            </div><!--Fin  Personal-->
            <!--Inicio Personal 1-->
            <div class="tab-pane fade" id="custom-tabs-one-personal2" role="tabpanel" aria-labelledby="custom-tabs-one-personal2-tab">
            ...
            <!--Inicio Personal 2-->
            <div class="tab-pane fade" id="custom-tabs-one-personal3" role="tabpanel" aria-labelledby="custom-tabs-one-personal3-tab">
            ...
            <!--INICIO referencias-->
            <div class="tab-pane fade" id="custom-tabs-one-referencias" role="tabpanel" aria-labelledby="custom-tabs-one-referencias-tab">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                   ...
                   <div class="col-sm-3"> 
                    ...
                    <div class="col-sm-3">
                      <input required type="checkbox" name="solicitar_informes" class="form-control">
                    </div>
                    <div class="col-sm-3">
                      <input required type="checkbox" name="solicitar_informes1" class="form-control">
                    </div>
                    <div class="col-sm-3">
                      <input required type="checkbox" name="solicitar_informes2" class="form-control">
                    </div>
                    <div class="col-sm-3">
                      <input required type="checkbox" name="solicitar_informes3" class="form-control">
                    ...
                    <!--Razones Informes separación Referencias-->
                     <label for="" class="col-form-label col-sm-12">Razones:</label>
                      <div class="col-sm-3">
                        <input required type="text" name="razones" class="form-control" onkeyup="mayus(this);" onkeypress="return validar(event)">
                      </div>
                      <div class="col-sm-3">
            ...
            <!--Inicio Contratación-->
            <div class="tab-pane fade" id="custom-tabs-one-contratacion" role="tabpanel" aria-labelledby="custom-tabs-one-contratacion-tab">
              ...
              <div class="form-group row">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <input required type="file" class="form-control" name="contrato_documento" accept="application/pdf">
                  </div>
                  ...
                  <div class="col-md-2 mb-3">
                    <br><br>
                    <div class="form-check">
                      <input required class="form-check-input" type="checkbox" name="ptu" value="option1" aria-label="">
                        ...
                        <div class="margin">
                            <div class="btn-group">
                                <div class="form-group">
                                    <button type="button" id="nuevomodal" style='width:70px; height:40px'> <i class="fas fa-user-plus"></i></button>
                                </div>
                        ...
                        <div class="margin">
                            <div class="btn-group">
                                <div class="form-group">
                                       ...
                                       <button id="nuevo_regmodal" name="acciones" value="registrar" type="submit" style="display: none;width:70px; height:40px"><i class="fas fa-save"></i></button>
