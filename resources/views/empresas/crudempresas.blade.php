            ...
            <div class="row">
                ...
                <div class="col-sm-1">
                    <div class="form-group">
                        ...
                        @if(isset($empresa))
                        <input type="text" name="clave" class="form-control" value="{{$empresa->clave}}" maxlength="4"
                            onkeyup="mayus(this);">
                        @error('clave')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        @if(isset($empresa))
                        <input type="text" name="nombre_nomina" class="form-control" value="{{$empresa->nombre_nomina}}"
                            onkeyup="mayus(this);">
                        @error('nombre_nomina')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="rfc" maxlength="13" minlength="12" class="form-control" value=""
                            onkeyup="mayus(this);"
                            pattern="^([A-ZÑ\x26]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})?$">
                        @error('rfc')
                        <div class="alert alert-secondary">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="segurosocial" maxlength="11" class="form-control" value=""
                            onkeyup="mayus(this)" ; onkeypress="return numeros(event)">
                        @error('segurosocial')
                        <div class="alert alert-secondary">
                            {{ $message }}
                        </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @else
                        <input type="text" name="registro_estatal" class="form-control" value="" maxlength="11"
                            onkeyup="mayus(this);">
                        @endif
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="calle" class="form-control" value="" onkeyup="mayus(this)" ;
                            onkeypress="return validar(event)">
                        @error('calle')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="colonia" class="form-control" value="" onkeyup="mayus(this);"
                            onkeypress="return validar(event)">
                        @error('colonia')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        @if(isset($empresa))
                        <input type="text" name="codigopostal" class="form-control" value="{{$empresa->codigopostal}}"
                            onkeyup="mayus(this);" onkeypress="return validar(event)" maxlength="5">
                        @error('codigopostal')
                        <div class="alert alert-secondary">
                            {{ $message }}
                        </div>
                        @enderror
                        @else
                        <input type="text" name="codigopostal" class="form-control" onkeyup="mayus(this);"
                            maxlength="5">
                        @error('codigopostal')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="municipio" class="form-control" value="" onkeyup="mayus(this);"
                            onkeypress="return validar(event)">
                        @error('municipio')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="ciudad" class="form-control" value="" onkeyup="mayus(this);"
                            onkeypress="return validar(event)">
                        @error('ciudad')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="pais" class="form-control" value="" onkeyup="mayus(this);"
                            onkeypress="return validar(event)">
                        @error('pais')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="representante_legal" maxlength="50" class="form-control" value=""
                            onkeyup="mayus(this);" onkeypress="return validar(event)">
                        @error('representante_legal')
                        <div class="alert alert-secondary">
                            {{ $message }}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @enderror
                        @else
                        <input type="text" name="rfc_representante" maxlength="13" class="form-control" value=""
                            onkeyup="mayus(this);"
                            pattern="^([A-ZÑ\x26]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1])([A-Z]|[0-9]){2}([A-ZÑ\x26]|[0-9]){1})?$">
                        @error('rfc_representante')
                        <div class="alert alert-secondary">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @else
                        <input type="text" name="telefono" id="telefono" max="10" class="form-control telefono" value=""
                            onkeypress="return numeros(event)">
                        @endif
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @else
                        <input type="number" min="-1" max="10" step="any" name="primaRiesgo"
                            class="form-control primaRiesgo">
                        @error('primaRiesgo')
                        <div class="alert alert-secondary">
                            {{ $message }}
                        </div>
