              ...
              <div class="col-sm-6">
                    <div class="card-body">
                        <div class="margin">
                            <div class="btn-group">
                                <div class="form-group">
                                    <button type="button" class="btn btn-block btn-secondary"><i class="fas fa-user-plus"></i></button>
                                </div>
                                <div class="form-group">
                                    <button type="button" class="btn btn-block btn-secondary"><i class="fas fa-pen-square"></i></button>
                                </div>
                                <div class="form-group">
                                    <button type="button" class="btn btn-block btn-secondary"><i class="fas fa-trash-alt"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
