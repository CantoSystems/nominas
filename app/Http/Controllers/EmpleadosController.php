...
return $configDb;
    ...
    DB::connection('DB_Serverr')->insert('insert into empleados(clave_empleado, clasificacion,
        ...
        duracion_trabajo1, nombre_compania1, direccion_compania1,
        telefono_compania1, sueldo1, motivo_separacion1, nombre_jefe1, 
        puesto_jefe1, solicitar_informes1, razones1, 
        duracion_trabajo2, nombre_compania2, direccion_compania2,
        telefono_compania2, sueldo2, motivo_separacion2, nombre_jefe2,
        puesto_jefe2, solicitar_informes2, razones2,
        duracion_trabajo3, nombre_compania3, direccion_compania3,
        telefono_compania3, sueldo3, motivo_separacion3, nombre_jefe3,
        puesto_jefe3, solicitar_informes3, razones3, 
        referencia, direccion_trabajo, telefono_referencia, ocupacion, tiempo,
        referencia1, direccion_trabajo1, telefono_referencia1, 
        ocupacion1, tiempo1, referencia2, direccion_trabajo2,
        ...
        tipo_sueldo, tipo_jornada, dias, horas_diarias,forma_pago, clave_banco,
        ...
        salario_anterior, causa_modificacion) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
            ...
            ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
            ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
            ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,)',[$clv_empleado,$datos->clasificacion,
            ...
            $datos->nombre_compania1,$datos->direccion_compania1,
            $datos->telefono_compania1,$datos->sueldo1,$datos->motivo_separacion1,
            $datos->nombre_jefe1,$datos->puesto_jefe1,$solicitar_informes1,
            $datos->razones1,$datos->duracion_trabajo2,$datos->nombre_compania2,
            $datos->direccion_compania2,$datos->telefono_compania2,$datos->sueldo2,
            $datos->motivo_separacion2,$datos->nombre_jefe2,$datos->puesto_jefe2,
            $solicitar_informes2,$datos->razones2,
            $datos->duracion_trabajo3,
            $datos->nombre_compania3,$datos->direccion_compania3,
            $datos->telefono_compania3,$datos->sueldo3,$datos->motivo_seperacion3,
            ...
            $datos->tiempo,$datos->referencia1,$datos->direccion_trabajo1,
            $datos->telefono_referencia1,
            $datos->ocupacion1,$datos->tiempo1,$datos->referencias2,
            $datos->direccion_trabajo2,$datos->telefono_referencia2,
            ...
            $datos->nivel,$datos->categoria,$datos->tipo_sueldo,
