...
Schema::connection('DB_Serverr')->create('empleados', function($table){
    ...
    $table->string('vinculacion_trabajo1');
    ...
    $table->string('vinculacion_trabajo2');
    ...
    $table->string('vinculacion_trabajo3');
