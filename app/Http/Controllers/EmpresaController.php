...
class EmpresaController extends Controller{
    ...
    */
    public function registrar($datos){
        ...
        $conceptos = Collect([
            ["clave_concepto" => "001P", "concepto" => "SUELDO", "formula" => "SD*DT","tipo" => "P","manejo" => "fijo", "cantidad" => NULL, "importe" => NULL,"monto" => NULL, "isr" => 1,"imss" => 1, "infonavit" => 0, "estatal" => 1, "isr_uma" => 0.00, "isr_porcentaje" => 0.00,"imss_uma" => 0.00, "imss_porcentaje" => 0.00],
            ...
            ["clave_concepto" => "004P", "concepto" => "FONDO DE AHORRO EMPRESA", "formula" => "SI(UMA*1.3>SD, UMA*1.3,SD)*PFA","tipo" => "P","manejo" => "fijo","cantidad" => NULL,"importe" => NULL,"monto" => NULL, "isr" => 0,"imss" => 0,"infonavit" =>  0, "estatal" => 1,"isr_uma" => 0.00,"isr_porcentaje" => 100.00,"imss_uma" => 0.00,"imss_porcentaje" => 100.00],
            ...
            ["clave_concepto" => "007P", "concepto" => "PRIMA VACACIONAL", "formula" => "SD*P_V/100", "tipo" =>"P", "manejo" => "variable","cantidad" => NULL, "importe" => NULL,"monto" => NULL,"isr" => 1,"imss" => 0,"infonavit" => 0,"estatal" => 1,"isr_uma" => 15.00,"isr_porcentaje" => 0.00, "imss_uma" =>0.00, "imss_porcentaje"=>100.00],
            ...
            ["clave_concepto" => "011P", "concepto" => "INDEMINIZACIONES", "formula" => NULL,"tipo" =>  "P", "manejo" => "fijo","cantidad" => NULL, "importe" => NULL, "monto" => NULL,"isr" =>  1, "imss" => 1, "infonavit" => 0, "estatal" => 1, "isr_uma" => 90.00, "isr_porcentaje" => 0.00, "imss_uma" => 0.00, "imss_porcentaje" => 100.00],
            ["clave_concepto" => "012P", "concepto" => "VALES DESPENSA", "formula" => NULL, "tipo" => "P", "manejo" => "variable", "cantidad" => NULL,"importe" => NULL, "monto" => NULL, "isr" => 0, "imss" => 0,"infonavit" => 0, "estatal" => 1, "isr_uma" => 0.00, "isr_porcentaje" => 0.00, "imss_uma" => 0.00,"imss_porcentaje" => 100.00],
            ...
            ["clave_concepto" => "014P", "concepto" => "AGUINALDO", "formula" => "SD*DA", "tipo" => "P","manejo" => "fijo","cantidad" => NULL, "importe" => NULL, "monto" => NULL,"isr" => 1,"imss" => 0, "infonavit" => 0,"estatal" => 1,"isr_uma" => 30.00, "isr_porcentaje" => 0.00, "imss_uma" => 0.00, "imss_porcentaje"  => 100.00],
            ["clave_concepto" => "015P", "concepto" => "COMISIONES", "formula" => NULL,"tipo" => "P","manejo" => "variable","cantidad" => NULL,"importe" => NULL, "monto" => NULL,"isr" => 1,"imss" => 1, "infonavit" => 0,"estatal" =>1, "isr_uma" =>0.00,"isr_porcentaje" => 0.00, 0.00,"imss_uma" => 0.00,"imss_porcentaje" => 0.00],
            ["clave_concepto" => "016P", "concepto" => "P.T.U.", "formula" => NULL,"tipo" => "P", "manejo" => "fijo", "cantidad" => NULL, "importe" => NULL, "monto" => NULL,"isr" => 1,"imss" => 0,"infonavit" => 0,"estatal" =>  1,"isr_uma" => 15.00,"isr_porcentaje"=> 0.00,"imss_uma" => 0.00,"imss_porcentaje" => 100.00],
            ...
            ["clave_concepto" => "023P", "concepto" => "HORAS EXTRAS SEMANAS ANTERIORES","formula" =>  NULL,"tipo" => "P","manejo" => "variable", "cantidad" => NULL,"importe" => NULL, "monto" => NULL,"isr" => 1, "imss" =>0,"infonavit" => 0, "estatal" => 1,"isr_uma" => 5.00,"isr_porcentaje" =>50.00, "imss_uma" => 0.00, "imss_porcentaje" => 100.00],
            ["clave_concepto" => "024P", "concepto" => "TRABAJO EN DIAS DE DESCANSO","formula" =>  "SD * 2","tipo" => "P","manejo" => "variable", "cantidad" => NULL,"importe" => NULL, "monto" => NULL,"isr" => 1, "imss" =>1,"infonavit" => 0, "estatal" => 1,"isr_uma" => 0.00,"isr_porcentaje" =>0.00, "imss_uma" => 0.00, "imss_porcentaje" => 0.00],
            ...
            ["clave_concepto" => "007D", "concepto" => "CREDITO INFONAVIT CANTIDAD", "formula" => NULL,"tipo" => "D", "manejo" => "variable", "cantidad" => NULL,"importe" => NULL, "monto" => NULL, "isr" => 0, "imss" => 0,"infonavit" => 0,"estatal" => 0,"isr_uma" => 0.00,"isr_porcentaje" => 0.00,"imss_uma" =>  0.00, "imss_porcentaje" => 0.00],
            ...
            ["clave_concepto" => "018D", "concepto" => "PENSION ALIMENTICIA PORCENTAJE", "formula" => NULL,"tipo" => "D", "manejo" => "fijo","cantidad" => NULL, "importe" =>  NULL, "monto" => NULL,"isr" => 0, "imss" => 0,"infonavit" => 0,"estatal" => 0, "isr_uma" => 0.00, "isr_porcentaje" => 0.00,"imss_uma" => 0.00,"imss_porcentaje" => 0.00],
            ...
            ["clave_concepto" => "020D", "concepto" => "PENSION ALIMENTICIA CANTIDAD", "formula" => NULL,"tipo" => "D", "manejo" => "fijo","cantidad" => NULL, "importe" =>  NULL, "monto" => NULL,"isr" => 0, "imss" => 0,"infonavit" => 0,"estatal" => 0, "isr_uma" => 0.00, "isr_porcentaje" => 0.00,"imss_uma" => 0.00,"imss_porcentaje" => 0.00],
            ["clave_concepto" => "021D", "concepto" => "CREDITO INFONAVIT PORCENTAJE", "formula" => NULL,"tipo" => "D", "manejo" => "variable", "cantidad" => NULL,"importe" => NULL, "monto" => NULL, "isr" => 0, "imss" => 0,"infonavit" => 0,"estatal" => 0,"isr_uma" => 0.00,"isr_porcentaje" => 0.00,"imss_uma" =>  0.00, "imss_porcentaje" => 0.00],
            ["clave_concepto" => "022D", "concepto" => "SEGURO DE VIVIENDA INFONAVIT", "formula" => NULL,"tipo" => "D", "manejo" => "variable", "cantidad" => NULL,"importe" => NULL, "monto" => NULL, "isr" => 0, "imss" => 0,"infonavit" => 0,"estatal" => 0,"isr_uma" => 0.00,"isr_porcentaje" => 0.00,"imss_uma" =>  0.00, "imss_porcentaje" => 0.00],
